...
public class TextureAtlas
{
    ...
    public void CreateAtlasComponentData(string directoryName, string outputFileName, int imageSize)
    {
        ...
        Parallel.For(0, names.Length,
            index => { fileData[index] = File.ReadAllBytes(names[index]); });
        ...
        // write out the directory it should go into
        Debug.Log(Directory.GetCurrentDirectory() + "/" + outputFileName);
    }
